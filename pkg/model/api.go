...
// @15070229 CustomHeader 定制化Header
...
type API struct {
	...
	ReqHeaders    []*ReqHeader    `json:"reqHeaders"`
...
// UnMarshalDelAPI unmarshal
func UnMarshalDelAPI(path, url string) *API {
	v := &API{Key: path, URL: parseAPIKey(url)}
	return v
}
